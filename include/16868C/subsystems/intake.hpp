...
class Intake {
	...
	private:
		...
		const std::array<double, 4> EJECT_POS = {2050, 3070, 4060, 1010};
		const double REDIRECT_POS = 330;
		const std::array<double, 4> HOLD_POS = {1700, 2870, 3880, 710}; //1650, 2820, 3830, 660
