...
lib16868C::TrackingWheel vertEnc(&vertRot, 2_in, 3.25_in);
lib16868C::TrackingWheel hortEnc(&hortRot, 2_in, 5_in);
okapi::DistanceSensor frontDistance(FRONT_DIST);
...
lib16868C::DistanceSensor frontDist(&frontDistance, 2.5_in);
lib16868C::DistanceSensor rightDist(&rightDistance, 2.5_in);
lib16868C::DistanceSensor backDist(&backDistance, 6.5_in);
lib16868C::DistanceSensor leftDist(&leftDistance, 2.5_in);
