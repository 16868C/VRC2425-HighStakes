...
lib16868C::TrackingWheel leftEnc(&leftDrive, 3.25_in, 6_in, GEAR_RATIO);
lib16868C::TrackingWheel rightEnc(&rightDrive, 3.25_in, 6_in, GEAR_RATIO);
lib16868C::TrackingWheel middleEnc(&middleRot, 2.75_in, 1_in);
